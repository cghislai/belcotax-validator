...
public class XsdReader {
    ...
    public static final String XSD_BELCOTAX_2025_XSD = "/xsd/Belcotax-2025.xsd";
    ...
    private static Map<String, Map<String, String>> parseXsdDocumentation() {
        try {
            ...
            Document doc = dBuilder.parse(XsdReader.class.getResourceAsStream(XSD_BELCOTAX_2025_XSD));
