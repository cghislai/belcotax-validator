...
import com.charlyghislain.belcotax.Belcotax2022Validator;
...
public class ValidationResource implements ValidationApi {
    ...
    public BelcotaxValidationResults validateBelcotax(String acceptedLanguage,
        ...
        try {
            ...
            ValidatedBelcotax validatedBelcotax = Belcotax2022Validator.validateBelcotaxXml(new ByteArrayInputStream(xmlBytes), optionsBuilder.build());
    ...
    public InputStream getBowFile(String acceptedLanguage,
        ...
        Optional.ofNullable(maxBlockingErrors)
                .ifPresent(optionsBuilder::maxBlockingErrors);
        try {
            ValidatedBelcotax validatedBelcotax = Belcotax2022Validator.validateBelcotaxXml(xmlContent, optionsBuilder.build());
