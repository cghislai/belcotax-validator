...
import com.charlyghislain.belcotax.Belcotax2025Validator;
...
public class ValidationResource implements ValidationApi {
    ...
    public BelcotaxValidationResults validateBelcotax(String acceptedLanguage,
        ...
        try {
            ...
            ValidatedBelcotax validatedBelcotax = Belcotax2025Validator.validateBelcotaxXml(new ByteArrayInputStream(xmlBytes), optionsBuilder.build());
    ...
    public InputStream getBowFile(String acceptedLanguage,
        ...
        Optional.ofNullable(maxBlockingErrors)
                .ifPresent(optionsBuilder::maxBlockingErrors);
        try {
            ValidatedBelcotax validatedBelcotax = Belcotax2025Validator.validateBelcotaxXml(xmlContent, optionsBuilder.build());
