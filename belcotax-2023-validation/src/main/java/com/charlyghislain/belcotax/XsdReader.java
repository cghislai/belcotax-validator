...
public class XsdReader {
    ...
    public static final String XSD_BELCOTAX_2023_XSD = "/xsd/Belcotax-2023.xsd";
    ...
    private static Map<String, Map<String, String>> parseXsdDocumentation() {
        try {
            ...
            Document doc = dBuilder.parse(XsdReader.class.getResourceAsStream(XSD_BELCOTAX_2023_XSD));
